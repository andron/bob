...
$(TGTDIR)/$1: __target_CFLAGS    = $(CFLAGS)   $(_CFLAGS)   $(strip $$($1_CFLAGS)   $(call __target_def,$1,$2) $(call __target_inc,$1,$2))
$(TGTDIR)/$1: __target_CXXFLAGS  = $(CXXFLAGS) $(_CXXFLAGS) $(strip $$($1_CXXFLAGS) $(call __target_def,$1,$2) $(call __target_inc,$1,$2))
$(TGTDIR)/$1: __target_LDFLAGS   = $(LDFLAGS)  $(CXXFLAGS) $(_LDFLAGS) $(_CXXFLAGS) $(strip $$($1_LDFLAGS) $$($1_LIBS) $$($1_LINKPATH) $$($1_LINK))
$(TGTDIR)/$1: __target_GNATFLAGS = $(GNATFLAGS) $(strip $$($1_GNATFLAGS))
# Depend on .o-files
$(TGTDIR)/$1: $($1_OBJS)
