...
$(TGTDIR)/$1: __target_CFLAGS    = $(_CFLAGS)   $(strip $$($1_CFLAGS)   $(call __target_def,$1,$2) $(call __target_inc,$1,$2))
$(TGTDIR)/$1: __target_CXXFLAGS  = $(_CXXFLAGS) $(strip $$($1_CXXFLAGS) $(call __target_def,$1,$2) $(call __target_inc,$1,$2))
$(TGTDIR)/$1: __target_LDFLAGS   = $(_LDFLAGS) $(CXXFLAGS) $(_CXXFLAGS) $(strip $$($1_LDFLAGS) $$($1_LIBS) $$($1_LINKPATH) $$($1_LINK))
